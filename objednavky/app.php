...
$row=$db->prepare('SELECT * FROM obchod_orders JOIN obchod_customers ON obchod_orders.orderCustomerId = obchod_customers.customerId JOIN obchod_ITEMS ON obchod_orders.orderProductId = obchod_ITEMS.product_ITEM_ID');
...
foreach($row as $rec)//foreach loop
{
  ...
  // send product info
  $json_array['productId']=$rec['obchod_ITEMS'];
  $json_array['productImg']=$rec['product_IMGURL'];
  $json_array['productFrom']=$rec['product_PRODUCTNAME'];
  $json_array['productCategory']=$rec['product_CATEGORYTEXT'];
  $json_array['productPrice']=$rec['product_PRICE_VAT'];
  $json_array['productDescription']=$rec['product_DESCRIPTION'];
